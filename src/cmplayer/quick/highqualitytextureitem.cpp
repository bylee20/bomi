...
//    Interpolator interpolator = Interpolator::Bilinear;
//};
...
//    , d(new Data)
//{
//    d->interpolator = Interpolator::get(Interpolator::Bilinear);
//}
...
//auto HighQualityTextureItem::interpolator() const -> Interpolator
//{
//    return d->interpolator->type();
//}

//auto HighQualityTextureItem::setInterpolator(Interpolator type) -> void
//{
//    if (type != Interpolator::Bilinear && !supportsHighQualityRendering())
//        type = Interpolator::Bilinear;
