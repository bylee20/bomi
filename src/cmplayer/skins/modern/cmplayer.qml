		...
		MouseArea {
			...
			Column {
				...
				Skin.HorizontalLayout {
					...
					TimeText { id: position; msecs: player.time; anchors.left: parent.left; verticalAlignment: texts.vAlignment }
					Text {
						id: name
					...
					TimeText { id: duration; msecs: player.duration; anchors.right: parent.right; verticalAlignment: texts.vAlignment}
				}
				Skin.HorizontalLayout {
